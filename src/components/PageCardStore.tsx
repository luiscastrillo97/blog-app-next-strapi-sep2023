...
const PageCardStore = ({ book }: Props) => {
    ...
    const handleClickAddToCart = () => {
        addCartProducts({ id, title, price: parseInt(price) });
        router.push("/cart");
    }
    return (
        <div className="max-w-xl mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <Image 
            ...
            <div className="p-5">
                ...
                <p className="text-gray-500 mb-2 text-lg">Price: ${ price }</p>
